...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libdeflate_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("46979653-d7f6-5232-b59e-dd310c4598de"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libdeflate", artifacts_toml) for e in artifacts["libdeflate"]]
...
if best_platform === nothing
    @debug("Unable to load libdeflate; unsupported platform $(triplet(platform_key_abi()))")
else
